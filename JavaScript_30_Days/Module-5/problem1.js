...
function describeValue(value){
    let valueType = typeof value;  //using typeof to get the type ot this value
    let truthOrFalsy = value ? "truthy" : "falsy"; //checking the values with the use of ternary oprs.
    return valueType + " | " + truthOrFalsy;  //using | to join the two values and returing.
